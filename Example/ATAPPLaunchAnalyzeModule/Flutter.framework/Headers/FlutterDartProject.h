...
/**
 * setup asset folder path for the flutter engine.
 *
 * @param assetsPath The path of the asset..
 */
+ (void)setupFlutterCustomAssetsPath:(NSString *)assetsPath;

/**
 * setup icu data file path for the flutter engine.
 *
 * @param icuDataPath The path of the icu data..
 */
+ (void)setupFlutterICUDataPath:(NSString *)icuDataPath;

/**
 * Returns the asset folder path
 */
+ (NSString*)flutterCustomAssetsPath;

/**
 * Returns the icu data file path path
 */
+ (NSString*)flutterCustomIcuDataPath;
