...
/**
 * The version for this FlutterEngine
 *
 * @return jdf_base_version.
 */
+ (NSString *)jdFlutterVersion;

/**
* setupVMSnapshotDataPath this FlutterEngine.
*
* The engine will execute the project located outside data path
*
* A newly initialized engine  must setup it before initialize
*
*
* @param vmSnapshotDataPath vm snapshot data file path
* @param isolateSnapshotDataPath isolates snapshot data file path
*/
+ (void)setupVMSnapshotDataPath:(NSString *)vmSnapshotDataPath isolateSnapshotDataPath:(NSString *)isolateSnapshotDataPath;
