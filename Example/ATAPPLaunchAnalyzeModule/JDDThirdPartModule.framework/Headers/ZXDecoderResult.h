...
@property (nonatomic, strong, readonly) NSMutableArray *songjixiangResultBitsSegments;
...
songjixiangResultBitsSegments:(NSMutableArray *)songjixiangResultBitsSegments ecLevel:(NSString *)ecLevel
